...
#define __GMP_CC "/Devel/NOVAsdk2019.07/Xcompiler/aarch64-arm-gcc-6.4.0/bin/ccache /usr/bin/gcc"
#define __GMP_CFLAGS "-O2 -I/Devel/NOVAsdk2019.07/Xcompiler/aarch64-arm-gcc-6.4.0/include"
