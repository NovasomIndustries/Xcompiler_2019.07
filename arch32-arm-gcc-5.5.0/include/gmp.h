...
#define __GMP_CC "/Devel/NOVAsdk/Xcompiler/arch32-arm-gcc-5.5.0/bin/ccache /usr/bin/gcc"
#define __GMP_CFLAGS "-O2 -I/Devel/NOVAsdk/Xcompiler/arch32-arm-gcc-5.5.0/include"
